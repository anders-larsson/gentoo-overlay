...
pkg_postinst() {
	elog ""
	elog "Remember to read release notes both for k3s and Kubernetes"
	elog "when updating k3s, especially with there is a major or minor update."
	elog "This to ensure a smooth upgrade."
	elog ""
}
